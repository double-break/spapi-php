...
* Source MD5 signature: ed5e8820930241acd871f23beac18405
*
*
...
class Orders extends Client {
  ...
  *    - *fulfillmentChannels* array - A list that indicates how an order was fulfilled. Filters the results by fulfillment channel. Possible values: AFN (Fulfillment by Amazon); MFN (Fulfilled by the seller).
  ...
  */
  ...
  {
    return $this->send("/orders/v0/orders/{$orderId}/regulatedInfo", [
      'method' => 'GET',
    ]);
  }
  ...
  {
    return $this->sendAsync("/orders/v0/orders/{$orderId}/regulatedInfo", [
      'method' => 'GET',
    ]);
  }
  ...
  *
  */
  public function updateVerificationStatus($orderId, $body = [])
  {
    return $this->send("/orders/v0/orders/{$orderId}/regulatedInfo", [
      'method' => 'PATCH',
      'json' => $body
  ...
  public function updateVerificationStatusAsync($orderId, $body = [])
  {
    return $this->sendAsync("/orders/v0/orders/{$orderId}/regulatedInfo", [
      'method' => 'PATCH',
      'json' => $body
